...
public class ManageLibrariansController {
    ...
    public void refresh() throws Exception {
        users.clear();
        users.addAll(service.getLibrarians());
    ...
    public void save(){
        ...
        try {
            service.addUser(username, pswd, Status.LIBRARIAN, fname, lname);
            User user = new User(username,Status.LIBRARIAN,fname,lname);
            users.add(user);
    ...
    public void update(){
        ...
        try {
            service.updateUser(username, pswd, Status.LIBRARIAN, fname, lname);
            refresh();
        }
        catch (Exception e){
            Alert alert = new Alert(Alert.AlertType.WARNING, e.getMessage(), ButtonType.OK);
